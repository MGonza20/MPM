        ...
        <div className="provisionalBackgorund">
          <div className="faqCont container">
            <div className="infoContainer">
              ...
              <form onSubmit={handleAddVet} data-testid={'handle-add-vet-test'}>
                <InputComponent
                ...
                <CheckboxGroup colorScheme="orange" defaultValue={['none']}>
                  <Stack spacing={[2, 3]} direction={['column']}>
                    ...
                    <Checkbox
                      data-testid={'examenes-corporales-test'}
                      value="Examenes Corporales"
                      onChange={(e) =>
                        setDicServices((prevTest) => ({
                          ...prevTest,
                          examenes_corporales: e.target.checked
                        }))
                      }
                    >
                      Examenes corporales
                    ...
                    <Checkbox
                      ...
                      onChange={(e) =>
                        setDicServices((prevTest) => ({
                          ...prevTest,
                          desparacitacion: e.target.checked
                        }))
                      }
                    >
                      Desparacitacion
                ...
                <br></br>
                <h1>Ingresa la ubicacion donde se encuentra la veterinaria</h1>
                <br></br>
                ...
                >
                  ...
                  />
                  <LocateMarker position={position} setPosition={setPosition} />
                </MapContainer>

                {position !== null && (
                  <div>
                    <p data-testid={'coords-text'}>Coordenadas Seleccionadas</p>
                    <p>
